...
public class FnordMetricClient {
    private static Random RNG = new Random();
    private static Logger log = Logger.getLogger(FnordMetricClient.class.getName());

    private InetSocketAddress _address;
    private DatagramChannel _channel;

    public FnordMetricClient(String host, int port) throws UnknownHostException, IOException {
        this(InetAddress.getByName(host), port);
    }

    public FnordMetricClient(InetAddress host, int port) throws IOException {
    ...
    public boolean send(String... stats) {
